...
if(UNIX)
    set(SIMPHONIZ_INSTALL_BIN_DIR ${CMAKE_INSTALL_BINDIR}/${SIMPHONIZ_PROJECT_NAME_L})
    set(SIMPHONIZ_INSTALL_LIB_DIR ${CMAKE_INSTALL_LIBDIR}/${SIMPHONIZ_PROJECT_NAME_L})
else()
    set(SIMPHONIZ_INSTALL_BIN_DIR ${CMAKE_INSTALL_BINDIR})
    set(SIMPHONIZ_INSTALL_LIB_DIR ${CMAKE_INSTALL_LIBDIR})
endif()

set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${SIMPHONIZ_OUTPUT_DIR}/${SIMPHONIZ_INSTALL_BIN_DIR})
set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${SIMPHONIZ_OUTPUT_DIR}/${SIMPHONIZ_INSTALL_LIB_DIR})
...
set(CMAKE_INSTALL_RPATH "$ORIGIN;$ORIGIN/../${SIMPHONIZ_INSTALL_LIB_DIR};$ORIGIN/../../${SIMPHONIZ_INSTALL_LIB_DIR}")
